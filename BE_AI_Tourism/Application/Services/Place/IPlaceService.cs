...
public interface IPlaceService
{
    ...
    Task<Result<PaginationResponse<PlaceResponse>>> GetAllPagedAsync(PlaceAdminQueryRequest request, Guid userId, string role, ContributorType? contributorType, Guid? userAdminUnitId);
