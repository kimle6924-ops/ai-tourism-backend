...
{
    Task<Result<EventResponse>> CreateAsync(CreateEventRequest request, Guid userId);
    ...
    Task<Result<PaginationResponse<EventResponse>>> GetAllPagedAsync(PaginationRequest request);
