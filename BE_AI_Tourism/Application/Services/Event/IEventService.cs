...
public interface IEventService
{
    ...
    Task<Result<PaginationResponse<EventResponse>>> GetAllPagedAsync(EventAdminQueryRequest request, Guid userId, string role, ContributorType? contributorType, Guid? userAdminUnitId);
    Task<Result<List<EventOccurrenceResponse>>> GetOccurrencesAsync(Guid id, EventOccurrencesQueryRequest request);
